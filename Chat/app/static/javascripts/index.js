$(function () {
    ...
    socket.on('getInquiry', function (msg) {
        ...
        // $('<div class="message new"><figure class="avatar"><img  src=' + msg.PictureUrl + '"/app/static/mugshot/" /></figure>' + msg.msg + '</div>').appendTo($('.mCSB_container')).addClass('new')
        setDate(msg.time);
        $('.message-input').val(null);
        updateScrollbar();
        // window.alert(msg.PictureUrl);
    });
